...
export default async function Footer() {
  const footer = await client.fetch(QUERY, {}, options);
    ...
    <footer className="bg-[#f5f5f5]">
      <div className="max-w-screen-md lg:max-w-screen-xl mx-auto px-5">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-y-4 py-10">
          <div className="flex justify-center items-center flex-wrap gap-x-8 gap-y-3">
            ...
            <div className="flex items-center gap-x-3">
              <div className="flex justify-center items-center h-10 w-10 border border-[#ccc] rounded-full">
                <svg
                  className="w-3.5 h-3.5 text-[#bd9e62]"
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
                  viewBox="0 0 512 512"
          ...
          <div className="flex items-center gap-x-3">
            <a
              className="group flex justify-center items-center h-10 w-10 hover:bg-[#bd9e62] transition-colors duration-500 border border-[#ccc] rounded-full"
              href={footer.instagramPageLink}
            >
              <svg
                className="w-3.5 h-3.5 text-[#bd9e62] group-hover:text-white"
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
                viewBox="0 0 448 512"
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-y-3 py-6 border-t border-[#ccc]">
          ...
          <div className="text-sm text-center">
            Powered by{" "}
            <a className="hover:underline" href="https://devignitr.com">
              Dev Ignitr
            </a>
          </div>
        </div>
